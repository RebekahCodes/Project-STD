...
✨ Form entry confirmation with easy "add-to-calendar" feature for your guests' convenience. <br/>
...
- [ ] Admin page to allow host to view guest info
- [ ] CSV data download for supplier communication
- [ ] Dashboard with stats on guests and event details
- [ ] Group guests by household
- [ ] Manually add, edit and delete guests from admin dashboard
