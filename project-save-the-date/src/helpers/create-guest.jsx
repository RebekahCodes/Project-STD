...
export async function createGuest(event, state) { // (event) represents the event object triggered by the fact that the button to activate this function was clicked e.g. form submission button.
